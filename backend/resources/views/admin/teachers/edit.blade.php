                        ...
                        <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="text-label" style="font-weight: 600;">Password (leave blank to keep current)</label>
                                        <input type="password" name="password" class="form-control" placeholder="New password if any">
                                    </div>
                                    <div class="form-group">
