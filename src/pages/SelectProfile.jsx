...
const SelectProfile = () => {
  ...
  return (
    <div className="select-profile-container" style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#0f172a', padding: '20px' }}>
      <motion.div 
