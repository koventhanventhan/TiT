...
const ContactPage = () => {
  ...
  const socialLinks = [
    { icon: <FiFacebook />, name: 'Facebook', link: '#facebook', color: '#1877F2' },
    { icon: <FiTwitter />, name: 'Twitter', link: '#twitter', color: '#1DA1F2' },
    { icon: <FiInstagram />, name: 'Instagram', link: '#instagram', color: '#E4405F' },
    { icon: <FiLinkedin />, name: 'LinkedIn', link: '#linkedin', color: '#0077B5' }
  ]
      ...
      <div className="contact-page-hero">
        <div className="container">
          ...
          <p className="contact-page-subtitle">
            Get in touch with us. We're here to help you with any questions or inquiries.
          </p>
        </div>
      </div>
