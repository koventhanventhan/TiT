...
<head>
    ...
    <title>Add Teacher - {{ config('app.name') }}</title>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="page-title d-flex justify-content-between align-items-center">
                            <h4 class="mb-0" style="font-size: 24px; font-weight: 600; color: #1f2937;">Add Teacher</h4>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div style="position: relative;">
                                                    <input type="password" name="password" id="teacherPassword" class="form-control" placeholder="At least 8 characters" required minlength="8" style="padding-right: 50px;">
                                                    <button type="button" onclick="togglePassword('teacherPassword', 'teacherEyeIcon')" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #6366f1; font-size: 18px; padding: 5px;">
                                                        <span id="teacherEyeIcon">ðŸ‘ï¸</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
