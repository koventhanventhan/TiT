...
<table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(79,70,229,0.08);">
    ...
    <tr>
        <td style="background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 100%);padding:32px 40px;text-align:center;">
            <h1 style="color:#ffffff;font-size:22px;margin:0 0 4px;">🎉 Account Approved!</h1>
    ...
    <tr>
        <td style="padding:36px 40px;">
            <h2 style="color:#1e1b4b;font-size:20px;margin:0 0 16px;">Congratulations, {{ $data['student_name'] ?? 'Student' }}! 🎓</h2>
            <p style="color:#4b5563;font-size:15px;line-height:1.7;margin:0 0 16px;">
                Your registration has been <strong>approved by admin</strong>. You now have full access to all classes and study materials.
            </p>
            <p style="color:#4b5563;font-size:15px;line-height:1.7;margin:0 0 16px;">
                உங்கள் பதிவு admin ஆல் <strong>அங்கீகரிக்கப்பட்டது</strong>. இப்போது நீங்கள் அனைத்து வகுப்புகள் மற்றும் பாட பொருட்களையும் அணுகலாம்.
            </p>
            <table cellpadding="0" cellspacing="0" style="background:#f5f3ff;border-radius:10px;width:100%;margin:20px 0;border-left:4px solid #7c3aed;">
                <tr><td style="padding:20px;">
                    <p style="color:#5b21b6;font-size:14px;margin:0;font-weight:600;">
                        🚀 Login now to start your learning journey!
                    </p>
                </td></tr>
            </table>
        </td>
