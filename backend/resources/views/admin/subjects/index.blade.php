                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <form action="{{ route('admin.subjects.destroy', $s->id) }}" method="POST" id="subj-del-{{ $s->id }}">
                                                @csrf @method('DELETE')
                                                <button type="button" class="dropdown-item text-danger swal-confirm-btn"
                                                    data-form-id="subj-del-{{ $s->id }}"
                                                    data-title="Delete Subject?"
                                                    data-text="Are you sure you want to delete this subject?">Delete</button>
                                            </form>
                                        </div>
                                    </div>
