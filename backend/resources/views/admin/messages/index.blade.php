...
<head>
    ...
    <style>
        ...
        .search_bar .form-control { background: rgba(255,255,255,0.1); color: #fff; border: none; border-radius: 0.5rem; padding: 0.75rem 2.8125rem 0.75rem 1.25rem; }
        .search_bar .form-control::placeholder { color: rgba(255,255,255,0.6); }
        .search_bar .search_icon { position: absolute; right: 0.9375rem; top: 50%; transform: translateY(-50%); color: rgba(255,255,255,0.6); background: none !important; padding: 0 !important; height: auto !important; }
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item" style="margin-right: 1.25rem;">
                                <a href="{{ env('FRONTEND_URL', 'http://localhost:4000') }}" target="_blank" class="btn btn-primary btn-sm" style="background: linear-gradient(135deg, #667eea, #764ba2); border: none; padding: 0.5rem 1.25rem; border-radius: 0.375rem; color: white; font-weight: 500;">Home</a>
                            </li>
